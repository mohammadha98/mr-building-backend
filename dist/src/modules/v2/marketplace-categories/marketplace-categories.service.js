...
let MarketplaceCategoriesService = class MarketplaceCategoriesService {
    ...
    async findActives(pagination, params) {
        ...
        if (pagination) {
            page = (0, pagination_util_1.PaginationSolver)(pagination).page;
            per_page = (0, pagination_util_1.PaginationSolver)(pagination).per_page;
            skip = (0, pagination_util_1.PaginationSolver)(pagination).skip;
        }
