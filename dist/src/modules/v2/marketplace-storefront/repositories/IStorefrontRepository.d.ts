...
export default interface IStorefrontRepository extends IRepository<any> {
    ...
    findNewItems(params: any, include: any, pagination?: IPagination): Promise<any[] | []>;
    ...
    getStorefrontIsBookmarked(clientId: number, storefrontId: string): Promise<StorefrontBookmark>;
}
