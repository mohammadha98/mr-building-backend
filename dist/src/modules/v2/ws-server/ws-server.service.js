...
let WsServerService = class WsServerService {
    ...
    async deleteChannelMessenger(body) {
        ...
        if (membersNotificationToken.length) {
            await this.fcmNotificationService.unSubscribeToTopic(membersNotificationToken, body.key);
        }
        return result;
    }
    ...
    async addMembersInGroupMessenger(body) {
        ...
        if (validationChannel) {
            ...
            await this.fcmNotificationService.subscribeToTopic(membersNotificationToken, body.group_info.key);
            return {
    ...
    async addMembersInChannelMessenger(body) {
        ...
        if (validationChannel) {
            ...
            console.log("membersNotificationToken");
            console.log(membersNotificationToken);
            await this.fcmNotificationService.subscribeToTopic(membersNotificationToken, body.channel_info.key);
            return {
                member_count: result.member_count,
                notification_tokens: membersNotificationToken,
            };
    ...
    async joinedGroupMessenger(body) {
        ...
        console.log(membersNotificationToken);
        await this.fcmNotificationService.subscribeToTopic(membersNotificationToken, body.source_key);
        return result;
    }
    ...
    async LeftMessenger(body) {
        ...
        console.log(membersNotificationToken);
        await this.fcmNotificationService.unSubscribeToTopic(membersNotificationToken, body.source_key);
        return result;
    }
