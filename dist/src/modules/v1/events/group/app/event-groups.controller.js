...
const Create_event_group_dto_1 = require("./dto/Create-event-group.dto");
...
let EventsGroupController = class EventsGroupController {
    ...
    async store(createEventGroupDto, req, res) {
        createEventGroupDto.user_id = req.user.id;
        const result = await this.groupsService.store(createEventGroupDto);
        if (result.status === 500) {
            throw new InternalServerErrorSchema_1.default();
        }
        const transformer = this.Transformer.transform(result.event, result.client);
        this.responsehandler.send(res, 201, "گروه جدید با موفقیت ایجاد شد.", transformer);
        this.groupsService.sendLoginInfoWithSMS({
    ...
    async findAllMys(query, req, res) {
        query.client_id = req.user.id;
        const result = await this.groupsService.findAllMyGroups(query);
        if (result.status === 403) {
            throw new forbiddenErrorHandler_1.ForbiddenErrorHandler();
        }
        const Transformer = this.Transformer.collection(result.groups, result.client);
...
__decorate([
    (0, swagger_1.ApiCreatedResponse)({
        ...
        schema: {
            ...
            properties: {
                ...
                message: {
                    type: "string",
                    example: "گروه جدید با موفقیت ایجاد شد.",
                },
                error: { type: "string" },
                data: {
                    type: "object",
    ...
    (0, swagger_1.ApiBody)({ type: Create_event_group_dto_1.CreateEventGroupDto }),
    (0, swagger_1.ApiConsumes)("multipart/form-data"),
    (0, swagger_1.ApiOperation)({ summary: "ایجاد گروه جلسه" }),
    ...
    __metadata("design:paramtypes", [Create_event_group_dto_1.CreateEventGroupDto, Object, Object]),
    __metadata("design:returntype", Promise)
], EventsGroupController.prototype, "store", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], EventsGroupController.prototype, "findAllMys", null);
__decorate([
    (0, swagger_1.ApiOkResponse)({
...
EventsGroupController = __decorate([
    ...
    (0, swagger_1.ApiTags)("v1/app-events-groups"),
    (0, common_1.Controller)("v1/app/events/groups"),
