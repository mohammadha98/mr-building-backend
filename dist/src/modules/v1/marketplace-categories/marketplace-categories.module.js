...
exports.MarketplaceCategoriesModule = void 0;
const common_1 = require("@nestjs/common");
const marketplace_categories_service_1 = require("./marketplace-categories.service");
const marketplace_categories_controller_1 = require("./marketplace-categories.controller");
...
let MarketplaceCategoriesModule = class MarketplaceCategoriesModule {
};
MarketplaceCategoriesModule = __decorate([
    (0, common_1.Module)({
        imports: [nestjs_form_data_1.NestjsFormDataModule],
        controllers: [marketplace_categories_controller_1.MarketplaceCategoriesController],
        providers: [
...
exports.MarketplaceCategoriesModule = MarketplaceCategoriesModule;
//# sourceMappingURL=marketplace-categories.module.js.map