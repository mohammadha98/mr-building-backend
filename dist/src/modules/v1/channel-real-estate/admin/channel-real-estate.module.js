...
exports.ChannelRealEstateAdminModule = void 0;
const common_1 = require("@nestjs/common");
const channel_real_estate_service_1 = require("./channel-real-estate.service");
const channel_real_estate_controller_1 = require("./channel-real-estate.controller");
...
let ChannelRealEstateAdminModule = class ChannelRealEstateAdminModule {
};
ChannelRealEstateAdminModule = __decorate([
    (0, common_1.Module)({
        imports: [nestjs_form_data_1.NestjsFormDataModule],
        controllers: [channel_real_estate_controller_1.ChannelRealEstateController],
        providers: [
        ...
        exports: [channel_real_estate_service_1.ChannelRealEstateService],
    })
], ChannelRealEstateAdminModule);
exports.ChannelRealEstateAdminModule = ChannelRealEstateAdminModule;
