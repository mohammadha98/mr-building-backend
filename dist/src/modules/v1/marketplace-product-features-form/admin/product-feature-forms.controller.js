...
exports.ProductFeatureFormsController = void 0;
const common_1 = require("@nestjs/common");
const product_feature_forms_service_1 = require("./product-feature-forms.service");
const create_productfeature_form_item_dto_1 = require("./dto/create-productfeature-form-item.dto");
const update_product_feature_form_dto_1 = require("./dto/update-product-feature-form.dto");
const swagger_1 = require("@nestjs/swagger");
const forbiddenErrorHandler_1 = require("../../../services/httpResponseHandler/forbiddenErrorHandler");
const httpResponsehandler_1 = require("../../../services/httpResponseHandler/httpResponsehandler");
const get_product_feature_forms_dto_1 = require("./dto/get-product-feature-forms.dto");
const Transformer_1 = require("./Transformer");
const badRequestErrorHandler_1 = require("../../../services/httpResponseHandler/badRequestErrorHandler");
const nestjs_form_data_1 = require("nestjs-form-data");
const update_sort_product_feature_forms_dto_1 = require("./dto/update-sort-product-feature-forms.dto");
const AdminTokenAuthGuard_1 = require("../../jwt-auth/AdminTokenAuthGuard");
const create_product_feature_form_dto_1 = require("./dto/create-product-feature-form.dto");
...
let ProductFeatureFormsController = class ProductFeatureFormsController {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_product_feature_form_dto_1.createProductFeatureFormsDto, Object, Object]),
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "createForm", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "findForms", null);
__decorate([
    (0, common_1.Patch)(),
    (0, swagger_1.ApiConsumes)("multipart/form-data"),
    (0, nestjs_form_data_1.FormDataRequest)(),
    ...
    __param(2, (0, common_1.Response)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_product_feature_form_dto_1.UpdateProductFeatureFormDto, Object, Object]),
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "updateForm", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "removeForm", null);
__decorate([
    (0, common_1.Post)("/items"),
    (0, swagger_1.ApiBody)({ type: create_productfeature_form_item_dto_1.CreateProductFeatureDto }),
    (0, swagger_1.ApiConsumes)("multipart/form-data"),
    ...
    __param(2, (0, common_1.Response)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_productfeature_form_item_dto_1.CreateProductFeatureDto, Object, Object]),
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "saveItem", null);
__decorate([
    ...
    __param(2, (0, common_1.Response)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_product_feature_forms_dto_1.GetProductFeaturesDto, Object, Object]),
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "findItems", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object, Object]),
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "removeItem", null);
__decorate([
    (0, common_1.Patch)("/items"),
    (0, swagger_1.ApiBody)({ type: update_product_feature_dto_1.UpdateProductFeatureDto }),
    (0, swagger_1.ApiConsumes)("multipart/form-data"),
    (0, nestjs_form_data_1.FormDataRequest)(),
    ...
    __param(2, (0, common_1.Response)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_product_feature_dto_1.UpdateProductFeatureDto, Object, Object]),
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "updateItem", null);
__decorate([
    ...
    __param(2, (0, common_1.Response)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_sort_product_feature_forms_dto_1.UpdateSortProductFeatureFormsDto, Object, Object]),
    __metadata("design:returntype", Promise)
], ProductFeatureFormsController.prototype, "updateDraggableItems", null);
ProductFeatureFormsController = __decorate([
    (0, common_1.UseGuards)(AdminTokenAuthGuard_1.default),
    (0, swagger_1.ApiSecurity)("JWT-auth"),
    (0, swagger_1.ApiTags)("v1/admin-marketplace-product-features-forms"),
    (0, common_1.Controller)("v1/admin/marketplace/product/features/forms"),
    __metadata("design:paramtypes", [product_feature_forms_service_1.ProductFeatureFormsService,
        Transformer_1.default,
        httpResponsehandler_1.HttpResponsehandler])
], ProductFeatureFormsController);
exports.ProductFeatureFormsController = ProductFeatureFormsController;
//# sourceMappingURL=product-feature-forms.controller.js.map