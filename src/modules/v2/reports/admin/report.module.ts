...
import RealEstateAdvisorTransformer from "src/modules/v2/real-estate-agents-advisors/admin/Transformer";
...
import RealEstateAdsPostgresqlRepository from "src/modules/v2/real-estate-ads/repositories/RealEstateAdsPostgresqlRepository";
