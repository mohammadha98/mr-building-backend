...
import { CreateCategoryRolePermissionsDto } from "src/modules/v1//admin-users-roles/private/dto/create-category-role-permissions";
import { CreateCategoryRolesDto } from "src/modules/v1//admin-users-roles/private/dto/create-category-roles";
import { UpdateCategoryRolesDto } from "src/modules/v1//admin-users-roles/private/dto/update-category-roles";
import { UpdatePermissionCategoryRoleDto } from "src/modules/v1//admin-users-roles/private/dto/update-category-roles-permission";
import adminUserRolesTransformer from "./Transformer";
import { HttpResponsehandler } from "src/modules/services/httpResponseHandler/httpResponsehandler";

@UseGuards(AdminTokenAuthGuard)
@ApiSecurity("JWT-auth")
@ApiTags("v1/admin-users-roles-categories")
@Controller("v1/admin/users/roles/private/categories")
