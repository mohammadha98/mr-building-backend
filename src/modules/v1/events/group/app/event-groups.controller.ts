...
@ApiTags("v1/app-events-groups")
@Controller("v1/app/events/groups")
export class EventsGroupController {
  ...
  @ApiBody({ type: CreateEventGroupDto })
  @ApiConsumes("multipart/form-data")
  @ApiOperation({ summary: "ایجاد گروه جلسه" })
  @FormDataRequest()
  @Post()
  async store(
  ...
  async findAllMys(
    ...
    const Transformer = this.Transformer.collection(
