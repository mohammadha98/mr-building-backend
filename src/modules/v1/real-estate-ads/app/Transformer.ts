...
import { AdsDetailTags } from "./dto/get-details-real-estate-ads.dto";
...
export default class RealEstateAdsTransformer implements ITransformer<any> {
  ...
  public transformDetails(item: any) {
    ...
    const owner_info = item.owner_info;
    ...
    return {
      ...
      is_active_chat: item.is_active_chat,
      owner_info,
      title: item.title,
  ...
  public transformNotificationSettings(item: any) {
    ...
    return {
      ...
      year_built_from: item.year_built_from,
      year_built_to: item.year_built_to,
      size_from: item.size_from,
      size_to: item.size_to,
      sale_price_from: item.sale_price_from.toString(),
      sale_price_to: item.sale_price_to.toString(),
      deposit_price_from: item.deposit_price_from.toString(),
      deposit_price_to: item.deposit_price_to.toString(),
      rent_price_from: item.rent_price_from.toString(),
      rent_price_to: item.rent_price_to.toString(),
      normal_days_price_from: item.normal_days_price_from.toString(),
      normal_days_price_to: item.normal_days_price_to.toString(),
      number_of_rooms_from: item.number_of_rooms_from,
      number_of_rooms_to: item.number_of_rooms_to,
      max_capicity_from: item.max_capicity_from,
      max_capicity_to: item.max_capicity_to,
